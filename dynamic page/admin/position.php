        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <form class="col-md-10" action="<?php echo $_SERVER['PHP_SELF']; ?>?from=poasition&id=<?php echo $current_edit['id'] ?>" method="post">
